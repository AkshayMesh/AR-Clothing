...
public class ActivityStartBindingImpl extends ActivityStartBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.app_name_tv, 2);
        sViewsWithIds.put(R.id.offline_text, 3);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((me.akshay.arclothing.ui.start.StartViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable me.akshay.arclothing.ui.start.StartViewModel ViewModel) {
